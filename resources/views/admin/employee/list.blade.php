                            ...
                            <div class="col-md-12">
                                ...
                                <div class="table-data__tool">
                                    ...
                                    <div class="table-data__tool-right">
                                        ...
                                        <a href="{{ route('admin.employee.add') }}" class="au-btn au-btn-icon au-btn--green au-btn--small">
                                                ...
                                                <tr class="tr-shadow">
                                                    ...
                                                    <td>
                                                        <div class="table-data-feature">
                                                            ...
                                                            @endif
                                                            @if(has_access('password_reset'))
                                                            <a href="{{ route('admin.role.resetPassword', $employee->id) }}" class="item" data-toggle="tooltip" data-placement="top" title="Reset Password">
