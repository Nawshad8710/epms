                            ...
                            <div class="col-sm-12">
                                <div class="table-data__tool">
                                    ...
                                    <div class="table-data__tool-right">
                                        ...
                                        <button class="au-btn au-btn-icon au-btn--green au-btn--small" data-toggle="modal" data-target="#menuHeadModal">
                                            <i class="zmdi zmdi-plus"></i>add menu head</button>
                                        @endif
                                        @if(has_access('create_menu'))
                                        <button class="au-btn au-btn-icon au-btn--green au-btn--small" data-toggle="modal" data-target="#menuModal">
                                            <i class="zmdi zmdi-plus"></i>add menu</button>
                                        @endif
                                    </div>
                                </div>
                                <div class="card">
                                    <div class="card-header"><strong>User Role</strong> Permissions</div>
                                    <div class="card-body">
