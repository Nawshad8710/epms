                            ...
                            <div class="col-md-12">
                                ...
                                <div class="table-data__tool">
                                    ...
                                    <div class="table-data__tool-right">
                                        ...
                                        <a href="{{ route('admin.role.userAdd') }}" class="au-btn au-btn-icon au-btn--green au-btn--small">
                                                ...
                                                <tr class="tr-shadow">
                                                    ...
                                                    <td>
                                                        <div class="table-data-feature">
                                                            ...
                                                            <a href="{{ route('admin.role.resetPassword', $user->id) }}" class="item" data-toggle="tooltip" data-placement="top" title="Reset Password">
